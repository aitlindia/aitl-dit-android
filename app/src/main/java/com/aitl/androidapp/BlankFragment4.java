...
public class BlankFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b6.setOnClickListener(b6Listner);

        return view;
    }

    Button.OnClickListener b6Listner = new Button.OnClickListener(){

        @Override
        public void onClick(View view) {
            Toast.makeText(getActivity(),"Fragment 4 Clicked!",Toast.LENGTH_SHORT).show();
        }
    };
